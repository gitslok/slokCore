...
contract NFTPoolFactory {
    ISlokMaster public immutable master; // Address of the master
    IERC20 public immutable slokToken;
    IVeSlokToken public immutable veSlokToken;
