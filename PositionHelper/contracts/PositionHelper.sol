...
contract PositionHelper is ReentrancyGuard {
    ...
    ISlokRouter public immutable router;
    address public immutable weth;

    uint256 expectedTokenId;
    address expectedNftPool;

    constructor(ISlokRouter router_, address weth_) {
        router = router_;
        weth = weth_;
    }
    ...
    function addLiquidityAndCreatePosition(
        ...
        (uint256 lpAmount_, , , uint256 lockDuration_, , , , ) = nftPool
            .getStakingPosition(expectedTokenId);
        require(
            lpAmount == lpAmount_ && lockDuration == lockDuration_,
